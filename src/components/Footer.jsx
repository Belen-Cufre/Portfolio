  ...
  return (
    ...
    ${styles.paddingX} w-full flex items-center py-5 bottom-0 z-20 bg-tertiary`}>
      <div className='w-full flex justify-between items-center max-w-9xl mx-auto'>
        ...
        <p className='text-white text-[14px] font-bold cursor-pointer'>Este portfolio ha sido creado siguiendo los pasos de JavaScript Mastery y reversionado por Belén Cufré.</p>  
        </div>
    </div>
  )
}
